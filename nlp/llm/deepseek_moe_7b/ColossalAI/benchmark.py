...
# deepseek-ai/deepseek-moe-16b-base  model_path
MODEL_CONFIGS = {
    "100m": lambda model_path: AutoConfig.from_pretrained(
        model_path,
    ...
    "7b": lambda model_path: AutoConfig.from_pretrained(
        model_path,
        max_position_embeddings=4096,
    ...
    "14b": lambda model_path: AutoConfig.from_pretrained(
        model_path,
        max_position_embeddings=4096,
...
def main():
    ...
    parser.add_argument("--model_path", type=str, default=None, help="the path of model and config")
    args = parser.parse_args()

    colossalai.launch_from_torch()
    coordinator = DistCoordinator()
    coordinator.print_on_master(f"args:{args}")
    ...
    config = MODEL_CONFIGS[args.config](args.model_path)
