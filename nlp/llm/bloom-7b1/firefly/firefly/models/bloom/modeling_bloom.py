...
class BloomBlock(nn.Module):
    ...
    def forward(
        ...
        layernorm_output = self.input_layernorm(hidden_states).to(hidden_states.dtype)
        ...
        layernorm_output = self.post_attention_layernorm(attention_output).to(attention_output.dtype)
...
class BloomModel(BloomPreTrainedModel):
    ...
    def forward(
        ...
        **deprecated_arguments,
        ...
        hidden_states = self.word_embeddings_layernorm(inputs_embeds).to(inputs_embeds.dtype)
