...
def create_optimizer(loss, init_lr, num_train_steps, num_warmup_steps, manual_fp16=False, use_fp16=False, num_accumulation_steps=1,
                     optimizer_type="adam", allreduce_post_accumulation=False, init_loss_scale=2**32, weight_decay_rate=0.01,beta_1=0.9, beta_2=0.999, epsilon=1e-6,power = 0.5,hvd=None, use_tpu=False):
