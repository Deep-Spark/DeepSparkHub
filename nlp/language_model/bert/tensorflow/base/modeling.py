  ...
  def __init__(self,
    ...
    with tf.compat.v1.variable_scope(scope, default_name="bert", custom_getter=get_custom_getter(compute_type)):
      ...
      with tf.compat.v1.variable_scope("pooler"):
        ...
        pooled_dense_layer = tf.keras.layers.Dense(
                units=config.hidden_size,
                activation=tf.tanh,
                kernel_initializer=create_initializer(config.initializer_range)
            )
        self.pooled_output = pooled_dense_layer(first_token_tensor)
...
#       kernel_initializer=create_initializer(initializer_range))
  ...
  dense_layer_q = tf.keras.layers.Dense(
        units=num_attention_heads * size_per_head,
        activation=query_act,
        kernel_initializer=create_initializer(initializer_range),
        name="query"
    )
  query_layer = dense_layer_q(from_tensor_2d)
...
#       name="key",
#       kernel_initializer=create_initializer(initializer_range))
  dense_layer_k = tf.keras.layers.Dense(
        units=num_attention_heads * size_per_head,
        activation=key_act,
        kernel_initializer=create_initializer(initializer_range),
        name="key"
    )
  key_layer = dense_layer_k(to_tensor_2d)
...
#       name="value",
#       kernel_initializer=create_initializer(initializer_range))
  dense_layer_v = tf.keras.layers.Dense(
        units=num_attention_heads * size_per_head,
        activation=value_act,
        kernel_initializer=create_initializer(initializer_range),
        name="value"
    )
  value_layer = dense_layer_v(to_tensor_2d)
  ...
  for layer_idx in range(num_hidden_layers):
    with tf.compat.v1.variable_scope("layer_%d" % layer_idx):
      ...
      with tf.compat.v1.variable_scope("attention"):
        ...
        #       hidden_size,
        #       kernel_initializer=create_initializer(initializer_range))
          attention_output_dense_layer = tf.keras.layers.Dense(
            units=hidden_size,
            kernel_initializer=create_initializer(initializer_range),
          )
          attention_output = attention_output_dense_layer(attention_output)
      ...
      with tf.compat.v1.variable_scope("intermediate"):
        ...
        #     kernel_initializer=create_initializer(initializer_range))
          intermediate_output_dense_layer = tf.keras.layers.Dense(
            units=intermediate_size,
            activation=intermediate_act_fn,
            kernel_initializer=create_initializer(initializer_range),
          )
          intermediate_output = intermediate_output_dense_layer(attention_output)
      ...
      with tf.compat.v1.variable_scope("output"):
        ...
        #     hidden_size,
        #     kernel_initializer=create_initializer(initializer_range))
        layer_output_dense_layer = tf.keras.layers.Dense(
            units=hidden_size,
            kernel_initializer=create_initializer(initializer_range),
          )
        layer_output = layer_output_dense_layer(intermediate_output)
