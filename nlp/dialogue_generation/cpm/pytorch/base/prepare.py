...
def prepare_data():
    checked_files = ["train.txt", "valid.txt", "cpm_model_states_medium.pt"]
    ...
    cmds = [
        f"cd {path_join(MODEL_DIR, 'data_preprocessing')}",
        f"DATA_DIR={DATA_DIR} bash prepare_data.sh"
    ]
...
def install_extensions():
    ...
    sandbox_dir = os.path.join(MODEL_DIR, 'sandbox', "extension")
