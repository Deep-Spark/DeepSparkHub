...
class GPT2Model(torch.nn.Module):
    ...
    def __init__(self,
        ...
        # word_embeddings.weight的形状：[vocab_size, hidden_size] ,vocab_size 为词汇表大小
        self.word_embeddings =torch.nn.Embedding(vocab_size, hidden_size)
        init_method(self.word_embeddings.weight)

        # Position embedding (serial).
        # position_embeddings.weight的形状：[max_sequence_length, hidden_size]，max_sequence_length为模型支持的最大句子长度，固定为1024    
