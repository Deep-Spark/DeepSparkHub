...
def parse_args():
    ...
    parser.add_argument("--node_rank", type=int, default=0,
                        help="The rank of the node for multi-node distributed "
                             "training")
    parser.add_argument("--nproc_per_node", type=str, default="auto",
...
def main():
    ...
    NCORES_PER_SOCKET = args.ncores_per_socket
    ...
    for local_rank in range(0, args.nproc_per_node):
        ...
        socket_rank = local_rank % NGPUS_PER_SOCKET
        cur_socket = local_rank // NGPUS_PER_SOCKET
        ...
        cpu_ranges = [NCORES_PER_SOCKET * cur_socket + socket_rank * NCORES_PER_GPU,
                     NCORES_PER_SOCKET * cur_socket + (socket_rank + 1) * NCORES_PER_GPU - 1,
                     NCORES_PER_SOCKET * cur_socket + socket_rank * NCORES_PER_GPU + (NCORES_PER_SOCKET * NSOCKETS),
                     NCORES_PER_SOCKET * cur_socket + (socket_rank + 1) * NCORES_PER_GPU + (NCORES_PER_SOCKET * NSOCKETS) - 1]
