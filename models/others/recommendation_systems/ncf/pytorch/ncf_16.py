...
def main():
    ...
    args = parse_args()
    print("args.no_cuda: ",args.no_cuda)  # false, 就是有cuda
    ...
    sorted_items, indices = (test_items != test_pos).to(torch.uint8).sort() 
    ...
    if args.fp16:
        ...
        optimizer = FusedAdam(param_optimizer,
