...
from model.ops import MultiScaleRoIAlign
...
__all__ = [
    ...
    "fasterrcnn_mobilenet_v3_large_fpn","fasterrcnn_pvanet_fpn"
]
...
def fasterrcnn_pvanet_fpn(pretrained=False, progress=True,
                            num_classes=91, pretrained_backbone=True, trainable_backbone_layers=None, **kwargs):
