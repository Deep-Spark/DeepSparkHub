...
import torch
from satrn.ops.roi_align import roi_align
...
class BaseInstanceMasks(metaclass=ABCMeta):
    ...
    def rescale(self, scale, interpolation='nearest'):
        ...
        For details can refer to `ocrcv.imrescale`.

        Args:
            scale (tuple[int]): The maximum size (h, w) of rescaled mask.
            interpolation (str): Same as :func:`ocrcv.imrescale`.
    ...
    def resize(self, out_shape, interpolation='nearest'):
        ...
        Args:
            ...
            interpolation (str): See :func:`ocrcv.imresize`.
    ...
    def crop_and_resize(self,
        ...
        Args:
            ...
            interpolation (str): See `ocrcv.imresize`
    ...
    def translate(self,
        ...
        Args:
            ...
            interpolation (str): Same as :func:`ocrcv.imtranslate`.
    ...
    def shear(self,
        ...
        Args:
            ...
            interpolation (str): Same as in :func:`ocrcv.imshear`.
...
class BitmapMasks(BaseInstanceMasks):
    ...
    Example:
        >>> from ocrdet.core.mask.structures import *  # NOQA
    ...
    def rescale(self, scale, interpolation='nearest'):
        ...
        if len(self.masks) == 0:
            new_w, new_h = ocrcv.rescale_size((self.width, self.height), scale)
            rescaled_masks = np.empty((0, new_h, new_w), dtype=np.uint8)
        else:
            rescaled_masks = np.stack([
                ocrcv.imrescale(mask, scale, interpolation=interpolation)
    ...
    def flip(self, flip_direction='horizontal'):
        ...
        if len(self.masks) == 0:
            ...
            flipped_masks = np.stack([
                ocrcv.imflip(mask, direction=flip_direction)
                for mask in self.masks
            ])
    ...
    def pad(self, out_shape, pad_val=0):
        ...
        if len(self.masks) == 0:
            ...
            padded_masks = np.stack([
                ocrcv.impad(mask, shape=out_shape, pad_val=pad_val)
                for mask in self.masks
            ])
    ...
    def translate(self,
        ...
        Example:
            >>> from ocrdet.core.mask.structures import BitmapMasks
        ...
        if len(self.masks) == 0:
            ...
            translated_masks = ocrcv.imtranslate(
    ...
    def random(cls,
        ...
        """
        from ocrdet.utils.util_random import ensure_rng
        rng = ensure_rng(rng)
...
class PolygonMasks(BaseInstanceMasks):
    ...
    def random(cls,
        ...
        Example:
            >>> from ocrdet.core.mask.structures import PolygonMasks
