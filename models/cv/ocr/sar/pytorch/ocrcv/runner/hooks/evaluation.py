...
from ocrcv.utils import is_seq_of
...
class EvalHook(Hook):
    ...
    Args:
        ...
        test_fn (callable, optional): test a model with samples from a
            ...
            test function ``ocrcv.engine.single_gpu_test`` will be used.
            (default: ``None``)
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from ocrcv.engine import single_gpu_test
    ...
    def evaluate(self, runner, results):
        ...
        Args:
            runner (:obj:`ocrcv.Runner`): The underlined training runner.
...
class DistEvalHook(EvalHook):
    ...
    Args:
        ...
        test_fn (callable, optional): test a model with samples from a
            ...
            ``None``, the default test function ``ocrcv.engine.multi_gpu_test``
            will be used. (default: ``None``)
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from ocrcv.engine import multi_gpu_test
