...
class LoadImageFromFile:
    ...
    Args:
        to_float32 (bool): Whether to convert the loaded image to a float32
            ...
            Defaults to False.
        color_type (str): The flag argument for :func:`ocrcv.imfrombytes`.
            Defaults to 'color'.
        file_client_args (dict): Arguments to instantiate a FileClient.
            See :class:`ocrcv.fileio.FileClient` for details.
    ...
    def __call__(self, results):
        ...
        Args:
            results (dict): Result dict from :obj:`ocrdet.CustomDataset`.
        ...
        if self.file_client is None:
            self.file_client = ocrcv.FileClient(**self.file_client_args)
        ...
        img = ocrcv.imfrombytes(img_bytes, flag=self.color_type)
        if self.to_float32:
...
class LoadMultiChannelImageFromFiles:
    ...
    def __call__(self, results):
        ...
        for name in filename:
            ...
            img.append(ocrcv.imfrombytes(img_bytes, flag=self.color_type))
...
class LoadAnnotations:
    ...
    def _load_semantic_seg(self, results):
        ...
        img_bytes = self.file_client.get(filename)
        results['gt_semantic_seg'] = ocrcv.imfrombytes(
