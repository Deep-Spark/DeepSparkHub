...
from dbnet_det.core import eval_map, eval_recalls
...
class CustomDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.file_client = dbnet_cv.FileClient(**file_client_args)
        ...
        if hasattr(self.file_client, 'get_local_path'):
            ...
            warnings.warn(
                'The used DBNET_CV version does not have get_local_path. '
                f'We treat the {self.ann_file} as local paths and it '
                'might cause errors if the path is not a local path. '
                'Please use DBNET_CV>= 1.3.16 if you meet errors.')
    ...
    def load_annotations(self, ann_file):
        ...
        return dbnet_cv.load(ann_file)

    def load_proposals(self, proposal_file):
        """Load proposal from proposal file."""
        return dbnet_cv.load(proposal_file)
    ...
    def get_classes(cls, classes=None):
        ...
        if isinstance(classes, str):
            ...
            class_names = dbnet_cv.list_from_file(classes)
