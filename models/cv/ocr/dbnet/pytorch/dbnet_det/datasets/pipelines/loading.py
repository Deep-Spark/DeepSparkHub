...
class LoadImageFromFile:
    ...
    Args:
        to_float32 (bool): Whether to convert the loaded image to a float32
            ...
            Defaults to False.
        color_type (str): The flag argument for :func:`dbnet_cv.imfrombytes`.
            Defaults to 'color'.
        file_client_args (dict): Arguments to instantiate a FileClient.
            See :class:`dbnet_cv.fileio.FileClient` for details.
    ...
    def __call__(self, results):
        ...
        if self.file_client is None:
            self.file_client = dbnet_cv.FileClient(**self.file_client_args)
...
class LoadMultiChannelImageFromFiles:
    ...
    def __call__(self, results):
        ...
        for name in filename:
            ...
            img.append(dbnet_cv.imfrombytes(img_bytes, flag=self.color_type))
...
class LoadAnnotations:
    ...
    def _load_semantic_seg(self, results):
        ...
        img_bytes = self.file_client.get(filename)
        results['gt_semantic_seg'] = dbnet_cv.imfrombytes(
