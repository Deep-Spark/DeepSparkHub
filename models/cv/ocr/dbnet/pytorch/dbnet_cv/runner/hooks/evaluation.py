...
from dbnet_cv.utils import is_seq_of
...
class EvalHook(Hook):
    ...
    Args:
        ...
        test_fn (callable, optional): test a model with samples from a
            ...
            test function ``dbnet_cv.engine.single_gpu_test`` will be used.
            (default: ``None``)
        ...
        file_client_args (dict): Arguments to instantiate a FileClient.
            See :class:`dbnet_cv.fileio.FileClient` for details. Default: None.
            `New in version 1.3.16.`
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from dbnet_cv.engine import single_gpu_test
    ...
    def evaluate(self, runner, results):
        ...
        Args:
            runner (:obj:`dbnet_cv.Runner`): The underlined training runner.
...
class DistEvalHook(EvalHook):
    ...
    Args:
        ...
        test_fn (callable, optional): test a model with samples from a
            ...
            ``None``, the default test function ``dbnet_cv.engine.multi_gpu_test``
            will be used. (default: ``None``)
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from dbnet_cv.engine import multi_gpu_test
