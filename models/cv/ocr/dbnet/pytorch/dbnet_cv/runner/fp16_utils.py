...
try:
    ...
    # and used; otherwise, auto fp16 will adopt dbnet_cv's implementation.
...
def auto_fp16(
    ...
    backend, otherwise, original dbnet_cv implementation will be adopted.
...
def force_fp32(apply_to: Optional[Iterable] = None,
    ...
    torch.cuda.amp is used as the backend, otherwise, original dbnet_cv
...
def allreduce_grads(params: List[Parameter],
    ...
    warnings.warn(
        '"dbnet_cv.runner.fp16_utils.allreduce_grads" is deprecated, and will be '
        'removed in v2.8. Please switch to "dbnet_cv.runner.allreduce_grads',
        DeprecationWarning)
