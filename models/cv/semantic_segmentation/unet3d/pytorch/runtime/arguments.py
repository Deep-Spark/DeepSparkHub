...
PARSER.add_argument('--log_name', dest='log_name', type=str, default="log.json")
...
PARSER.add_argument('--lr_decay_factor', dest='lr_decay_factor', type=float, default=0.5)
PARSER.add_argument('--lr_decay_patience', dest='lr_decay_patience', type=int, default=5)
