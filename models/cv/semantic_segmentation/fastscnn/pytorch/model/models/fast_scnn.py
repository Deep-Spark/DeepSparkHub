...
class FastSCNN(SegBaseModel):
    def __init__(self, cfg):
        super(FastSCNN, self).__init__(cfg, need_backbone=False)
...
class FeatureFusionModule(nn.Module):
    ...
    def forward(self, higher_res_feature, lower_res_feature):
        lower_res_feature = F.interpolate(lower_res_feature, higher_res_feature.shape[2:], mode='bilinear', align_corners=True)
