...
class LinkNet(nn.Module):
    ...
    def __init__(self, n_classes=21, backbone_cfg=dict()):
        """
        ...
        base = resnet18(cfg=backbone_cfg)
...
def linknet(num_classes):
    ...
    backbone_cfg = dict2obj(backbone_cfg)
    return LinkNet(num_classes, backbone_cfg)
