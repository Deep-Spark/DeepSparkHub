...
parser.add_argument("--distributed", default=True, type=bool, help="if use ddp")
parser.add_argument("--sync_bn", default=False, type=bool, help="sync_bn for ddp")
parser.add_argument("--fp16", default=False, type=bool, help="whether use fp16")
parser.add_argument("--backbone", default="mobilefacenet", type=str, help="backbone")
parser.add_argument("--pretrained", default=False, type=bool, help="state_dict for backbone")
parser.add_argument("--load_from", default="", type=str, help="state_dict for whole model")

parser.add_argument("--Epoch", default=100, type=int, help="state_dict for whole model")
parser.add_argument("--batch_size", default=128, type=int, help="batchsize for single gpu")
parser.add_argument("--save_period", default=1, type=int, help="save_period")
parser.add_argument("--save_dir", default="logs", type=str, help="save_dir")
...
if __name__ == "__main__":
    ...
    lfw_pairs_path  = "datasets/lfw_pair.txt"
    ...
    if distributed:
        ...
        dist_backend = "nccl"
        print('| distributed init (rank {}) (size {})'.format(rank, world_size), flush=True)
