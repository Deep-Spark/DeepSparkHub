...
model = dict(
    ...
    generator=dict(
        ...
        edvr_pretrained='https://download.openmmlab.com/mmediting/restorers/iconvsr/edvrm_reds_20210413-3867262f.pth'),
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='data/REDS/train/train_sharp_bicubic/X4',
            gt_folder='data/REDS/train/train_sharp',
            num_input_frames=15,
