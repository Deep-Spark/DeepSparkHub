...
model = dict(
    ...
    perceptual_loss=dict(
        ...
        style_weight=0,
        norm_img=False,
        pretrained='pretrained/vgg19-dcbb9e9d.pth'),
    gan_loss=dict(
        type='GANLoss',
        gan_type='vanilla',
        loss_weight=5e-2,
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='data/REDS/train/train_sharp_sub',
            gt_folder='data/REDS/train/train_sharp_sub',
            num_input_frames=15,
...
load_from = 'pretrained/realbasicvsr_wogan_c64b20_2x30x8_lr1e-4_300k_reds_20211027-0e2ff207.pth'  # noqa
resume_from = None
workflow = [('train', 1)]
