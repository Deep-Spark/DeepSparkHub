...
In train path, 000-751 is train data and remain is test data, move 752-1501 to test path.
...
4. (Optional) Prepare third party submodules
...
# fast-reid + deepsort
python3 deepsort.py [VIDEO_PATH] --fastreid [--config_fastreid ./configs/fastreid.yaml]

# MMDetection + deepsort
python3 deepsort.py [VIDEO_PATH] --mmdet [--config_mmdetection ./configs/mmdet.yaml]
```
