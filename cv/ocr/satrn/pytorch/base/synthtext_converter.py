...
def load_gt_data(filename, n_proc):
    ...
    return ocrcv.track_parallel_progress(
...
def process(data, img_path_prefix, out_dir):
    ...
    input_img = ocrcv.imread(os.path.join(img_path_prefix, img_path))
    ...
    for i, word in enumerate(words):
        ...
        ocrcv.imwrite(cropped_img, output_image_patch_path)
...
def main():
    ...
    ocrcv.track_parallel_progress(process_with_outdir, data, nproc=args.n_proc)
    print('Done')
