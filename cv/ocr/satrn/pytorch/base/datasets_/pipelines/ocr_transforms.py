...
from ocrcv.runner.dist_utils import get_dist_info
...
from datasets_.pipelines.crop import warp_img
...
class ResizeOCR:
    ...
    Args:
        ...
        backend (str | None): The image resize backend type. Options are `cv2`,
            ...
            specified by ``ocrcv.use_backend()`` will be used. Default: None.
    """
...
class RandomPaddingOCR:
    ...
    def __call__(self, results):
        ...
        img = ocrcv.impad(results['img'], padding=padding, padding_mode='edge')
