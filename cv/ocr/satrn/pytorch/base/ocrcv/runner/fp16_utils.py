...
from ocrcv.utils import TORCH_VERSION
from .dist_utils import allreduce_grads as _allreduce_grads

try:
    # If PyTorch version >= 1.6.0, torch.cuda.amp.autocast would be imported
    # and used; otherwise, auto fp16 will adopt ocrcv's implementation.
...
def auto_fp16(apply_to=None, out_fp32=False):
    ...
    backend, otherwise, original ocrcv implementation will be adopted.
...
def force_fp32(apply_to=None, out_fp16=False):
    ...
    torch.cuda.amp is used as the backend, otherwise, original ocrcv
...
def allreduce_grads(params, coalesce=True, bucket_size_mb=-1):
    warnings.warning(
        '"ocrcv.runner.fp16_utils.allreduce_grads" is deprecated, and will be '
        'removed in v2.8. Please switch to "ocrcv.runner.allreduce_grads')
