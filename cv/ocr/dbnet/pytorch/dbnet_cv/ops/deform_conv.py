...
from dbnet_cv.utils import deprecated_api_warning
...
class DeformConv2d(nn.Module):
    ...
    Note:
        ...
        flexibly and solved `issue dbnet_cv#1440
        <https://github.com/open-mmlab/dbnet_cv/issues/1440>`_.
