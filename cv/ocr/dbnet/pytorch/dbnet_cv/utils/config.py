...
class Config:
    ...
    Example:
        ...
        >>> cfg.filename
        "/home/kchen/projects/dbnet_cv/tests/data/config/a.py"
        >>> cfg.item4
        'test'
        >>> cfg
        "Config [path: /home/kchen/projects/dbnet_cv/tests/data/config/a.py]: "
    ...
    def _file2dict(filename, use_predefined_variables=True):
        ...
        with tempfile.TemporaryDirectory() as temp_config_dir:
            ...
            if filename.endswith('.py'):
                ...
                import dbnet_cv
                cfg_dict = dbnet_cv.load(temp_config_file.name)
            # close temp file
            temp_config_file.close()
    ...
    def dump(self, file=None):
        ...
        if file is None:
            if self.filename is None or self.filename.endswith('.py'):
                ...
                return dbnet_cv.dump(cfg_dict, file_format=file_format)
        elif file.endswith('.py'):
            with open(file, 'w', encoding='utf-8') as f:
                f.write(self.pretty_text)
        else:
            file_format = file.split('.')[-1]
            return dbnet_cv.dump(cfg_dict, file=file, file_format=file_format)
