...
from dbnet_cv.utils import _BatchNorm, _InstanceNorm, build_from_cfg, is_list_of
from dbnet_cv.utils.ext_loader import check_ops_exist
...
class DefaultOptimizerConstructor:
    ...
    def add_params(self,
        ...
        if check_ops_exist():
            from dbnet_cv.ops import DeformConv2d, ModulatedDeformConv2d
