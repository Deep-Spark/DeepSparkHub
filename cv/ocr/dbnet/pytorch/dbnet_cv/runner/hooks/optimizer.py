...
from dbnet_cv.utils import TORCH_VERSION, _BatchNorm, digit_version
...
if (TORCH_VERSION != 'parrots'
    ...
    class Fp16OptimizerHook(OptimizerHook):
        ...
        Args:
            loss_scale (float | str | dict): Scale factor configuration.
                ...
                Defaults to 512. For Pytorch >= 1.6, dbnet_cv uses official
    ...
    class Fp16OptimizerHook(OptimizerHook):  # type: ignore
        """FP16 optimizer hook (dbnet_cv's implementation).
    ...
    class GradientCumulativeFp16OptimizerHook(  # type: ignore
        ...
        """Fp16 optimizer Hook (using dbnet_cv implementation) implements multi-
