...
from ocrcv.runner import BaseModule, Sequential

import basic_utils
from models.builder import BACKBONES
from models.layers import BasicBlock
...
class ResNet31OCR(BaseModule):
    ...
    def __init__(self,
        ...
        assert basic_utils.is_type_list(layers, int)
        assert basic_utils.is_type_list(channels, int)
