...
if args.database is 'WebFace':
    args.train_list = 'cls_train.txt'
    args.num_class = 10575
    args.step_size = [16000, 24000]
elif args.database is 'VggFace2':
    args.train_list = 'VGG-Face2-112X96.txt'
    args.num_class = 8069
...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(
        ...
        batch_size=args.batch_size * num_gpus, shuffle=True,
    ...
    # ----------------------------------------train----------------------------------------
    # lfw_eval.eval(model_eval, args.save_path + 'CosFace_0_checkpoint.pth')
