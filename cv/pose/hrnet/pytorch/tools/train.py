...
from core.valider import do_valid
...
def parse_args():
    ...
    parser.add_argument('--eval_interval',
                        default=1,
                        type=int,
                        help='How many epoch calculate AP and AR in valid data')
    ...
    parser.add_argument('--output_dir',
                        ...
                        type=str, 
                        help='the directory of output(checkpoint and valid images)')
    parser.add_argument('--log_dir', 
                        default='./output/log', 
                        type=str, 
                        help='the log directory for saving events')
    ...
    parser.add_argument('--resume',
                        default='', 
                        type=str, 
                        help='the checkpoint of load predtrained')
...
def main_worker(
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        do_train(cfg, model, train_loader, loss_factory, optimizer, epoch,
                 final_output_dir, tb_log_dir, logger, fp16=cfg.FP16.ENABLED)
        ...
        if (epoch >= args.eval_interval and epoch % args.eval_interval == 0):
            ...
            try:
                perf_indicator = do_valid(cfg, model, epoch, final_output_dir, fp16=cfg.FP16.ENABLED)
            except:
                perf_indicator = -1
            ...
            if best_model:
                logger.info('=> saving best model checkpoint to {}'.format(final_output_dir))
                best_model_state_file = os.path.join(final_output_dir, "best_model.pth.tar")
        ...
        if not cfg.MULTIPROCESSING_DISTRIBUTED or (
            ...
            }, False, final_output_dir, filename)
