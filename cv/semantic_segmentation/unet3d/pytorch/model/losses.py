...
class Dice:
    ...
    def __call__(self, prediction, target):
        ...
        intersection_tp = target * prediction
        # intersection = torch.sum(intersection_tp.cpu(), dim=reduce_axis)
        # target_sum = torch.sum(target.cpu(), dim=reduce_axis)
        # prediction_sum = torch.sum(prediction.cpu(), dim=reduce_axis)
        intersection = torch.sum(intersection_tp, dim=reduce_axis)
