...
class CGNet(SegBaseModel):
    ...
    def __init__(self, cfg):
        super(CGNet, self).__init__(cfg, need_backbone=False)

        stage2_block_num = cfg.MODEL.CGNET.STAGE2_BLOCK_NUM
        stage3_block_num = cfg.MODEL.CGNET.STAGE3_BLOCK_NUM

        padding = int(padding_channel())

        # stage 1
        self.stage1_0 = _ConvBNPReLU(3 + padding, 32, 3, 2, 1, norm_layer=self.norm_layer)
        ...
        self.bn_prelu1 = _BNPReLU(32 + 3 + padding, norm_layer=self.norm_layer)

        # stage 2
        self.stage2_0 = ContextGuidedBlock(32 + 3 + padding, 64, dilation=2, reduction=8, down=True,
        ...
        self.bn_prelu2 = _BNPReLU(128 + 3 + padding, norm_layer=self.norm_layer)

        # stage 3
        self.stage3_0 = ContextGuidedBlock(128 + 3 + padding, 128, dilation=4, reduction=16, down=True,
                                           residual=False, norm_layer=self.norm_layer)
