...
def parse_requirements(fname='requirements/mmcv/runtime.txt', with_version=True):
...
setup(
    ...
    extras_require={
        'all': parse_requirements('requirements/mmcv/requirements.txt'),
        'tests': parse_requirements('requirements/mmcv/test.txt'),
        'build': parse_requirements('requirements/mmcv/build.txt'),
        'optional': parse_requirements('requirements/mmcv/optional.txt'),
    },
