...
def xception_a(cfg=None, norm_layer=nn.BatchNorm2d):
    model = XceptionA(cfg=cfg, norm_layer=norm_layer)
    return model


@BACKBONE_REGISTRY.register()
def xception65(cfg=None, norm_layer=nn.BatchNorm2d):
    model = Xception65(cfg=cfg, norm_layer=norm_layer)
    return model
