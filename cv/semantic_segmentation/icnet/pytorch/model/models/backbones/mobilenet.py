...
class MobileNet(nn.Module):
    def __init__(self, cfg=None, num_classes=1000, norm_layer=nn.BatchNorm2d):
...
def mobilenet_v1(cfg=None, norm_layer=nn.BatchNorm2d):
    return MobileNet(cfg=cfg, norm_layer=norm_layer)


@BACKBONE_REGISTRY.register()
def mobilenet_v2(cfg=None, norm_layer=nn.BatchNorm2d):
    return MobileNetV2(cfg=cfg, norm_layer=norm_layer)
