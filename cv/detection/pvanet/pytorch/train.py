...
# from model.faster_rcnn import fasterrcnn_pvanet_fpn
from model.model_main import get_pvanet_model_FRCNN
import _utils as utils
# PVANETFRCNN_DEFAULT_CFG = {
#     "backbone": "pvanet",
#     "num_classes": 6,
#     "pretrained": False,
...
def main(args):
    ...
    # model = pvanet_frcnn(PVANETFRCNN_DEFAULT_CFG
    ...
    #                             #    **kwargs
    #                                )
    model = get_pvanet_model_FRCNN(num_classes=num_classes)        
