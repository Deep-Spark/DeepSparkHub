...
std::vector<at::Tensor> nhwc_bn_fwd_train_cudnn_impl(
  ...
  AT_CUDNN_CHECK(cudnnBatchNormalizationForwardTrainingEx(
      ...
      fuse_add ? z.data_ptr<at::Half>() : nullptr,  // z for BN-Add-ReLU
      y_desc.desc(),
      y.data_ptr<at::Half>(),
      bn_desc.desc(),
      ...
      ws.data,
      ws_num_bytes,
      reserve.data_ptr<uint8_t>(),                        // reserve space ptr
...
std::vector<at::Tensor> nhwc_bn_bwd_cudnn_impl(
  ...
  AT_CUDNN_CHECK(cudnnBatchNormalizationBackwardEx(
      ...
      dy.data_ptr<at::Half>(),
      fuse_add ? dz_desc.desc() : nullptr,          // dz_desc
      fuse_add ? z_grad.data_ptr<at::Half>() : nullptr, // dz_data
      dx_desc.desc(),
      ...
      ws.data,
      ws_num_bytes,
      (fuse_add) ? reserve.data_ptr<uint8_t>() : nullptr,        // reserve space ptr
