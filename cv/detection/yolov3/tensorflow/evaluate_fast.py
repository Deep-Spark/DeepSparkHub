...
def get_ckpt_filename():
    with open("checkpoint/checkpoint") as fh:
        ckpt = fh.readline().rstrip().split(":")[-1].strip().strip('"')
    return os.path.join("checkpoint", ckpt)
...
class YoloTest(object):
    def __init__(self):
        ...
        self.weight_file      = get_ckpt_filename() 
