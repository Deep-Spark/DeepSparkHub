...
def train(cfg, local_rank, distributed, log_freq, random_number_generator):
    # Model logging
    ...
    log_event(key="iters_per_epoch", value=iters_per_epoch)
...
def main():
    ...
    parser.add_argument('--log-freq', default=20, type=int, help='print frequency')
    ...
    model, success = train(cfg, args.local_rank, args.distributed, args.log_freq, random_number_generator)
