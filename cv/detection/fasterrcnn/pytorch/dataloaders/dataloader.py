...
from . import presets_detection
from .pascal_voc import get_voc
...
def get_transform(train, data_augmentation="ssd"):
    return presets_detection.DetectionPresetTrain(data_augmentation) if train else presets_detection.DetectionPresetEval()
