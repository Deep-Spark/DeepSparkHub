...
2. In this directory, extract point clouds and annotations by running `python3 collect_indoor3d_data.py`.

3. Enter the project root directory, generate training data by running

```bash
python3 tools/create_data.py s3dis --root-path ./data/s3dis --out-dir ./data/s3dis --extra-tag s3dis
```
