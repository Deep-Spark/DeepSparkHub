...
def main():
    ...
    # 用于计算 average through output
    num_epoch_utts, num_epoch_time = 0.0, 0.0
    ...
    for epoch in range(start_epoch + 1, args.epochs + 1):
        ...
        num_epoch_utts += epoch_utts
        num_epoch_time += epoch_time
    ...
    log((), None, 'train_avg', {'throughput': num_epoch_utts / num_epoch_time})
