...
def main(args):
        ...
        if accelerator.is_main_process:
            if args.validation_prompt is not None and epoch % args.validation_epochs == 0:
                ...
                pipeline = StableDiffusion3Pipeline.from_pretrained(
                    ...
                    transformer=accelerator.unwrap_model(transformer.to(memory_format=torch.contiguous_format) if args.NHWC else transformer),
                    revision=args.revision,
                    variant=args.variant,
    ...
    if accelerator.is_main_process:
        ...
        if args.train_text_encoder:
            ...
            pipeline = StableDiffusion3Pipeline.from_pretrained(
                args.pretrained_model_name_or_path,
                transformer=transformer.to(memory_format=torch.contiguous_format) if args.NHWC else transformer,
