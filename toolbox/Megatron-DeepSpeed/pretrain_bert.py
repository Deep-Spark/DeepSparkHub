...
from megatron_ds.core.models.bert.bert_model import BertModel
...
from megatron_ds.core.models.bert.bert_layer_specs import bert_layer_with_transformer_engine_spec
...
def model_provider(pre_process=True, post_process=True):
    ...
    if args.use_mcore_models:
        ...
        model = megatron_ds.model.BertModel(
            config=config,
            num_tokentypes=num_tokentypes,
            add_binary_head=args.bert_binary_head,
            parallel_output=True,
