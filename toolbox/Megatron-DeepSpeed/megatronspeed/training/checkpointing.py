...
def save_checkpoint(iteration, model, optimizer, opt_param_scheduler, num_floating_point_operations_so_far=0, checkpointing_context=None,
                    ...
                    non_persistent_ckpt=False, train_data_iterator=None, preprocess_common_state_dict_fn = None):
    ...
    if args.async_save:
        ...
        elif ckpt_type == CheckpointType.GLOBAL and args.dist_ckpt_format != 'torch_dist':
    ...
    if not torch.distributed.is_initialized() \
            ...
            or ckpt_type != CheckpointType.LEGACY or args.deepspeed:
...
def load_args_from_checkpoint_wrapper(load_args_from_checkpoint):
    ...
    def wrapper(args, load_arg='load', checkpointing_context=None):
        args, checkpoint_args = load_args_from_checkpoint(args, load_arg, checkpointing_context)
...
def load_checkpoint(model, optimizer, opt_param_scheduler, load_arg='load', strict=True,
                    checkpointing_context=None, skip_load_to_model_and_opt=False, load_only_weights=False):
