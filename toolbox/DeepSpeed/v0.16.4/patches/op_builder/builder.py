...
class CUDAOpBuilder(OpBuilder):
    ...
    def compute_capability_args(self, cross_compile_archs=None):
        ...
        if self.jit_mode:
            ...
            if cross_compile_archs_env is not None and cross_compile_archs_env != "":
    ...
    def nvcc_args(self):
        ...
        if self.is_rocm_pytorch():
            ...
            args += [
                ...
                '-U__CUDA_NO_BFLOAT16_OPERATORS__','-U__CUDA_NO_BFLOAT16_OPERATORS__','-U__CUDA_NO_BFLOAT162_OPERATORS__'
