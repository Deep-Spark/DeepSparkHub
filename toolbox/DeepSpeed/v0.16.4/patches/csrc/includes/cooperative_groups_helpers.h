...
# endif
    ...
    // 表明支持 bfloat16
    #define _CG_HAS_BFLOAT16_SUPPORT
#endif
/*
** Define: CG_DEBUG
...
namespace __internal {
    ...
    _CG_STATIC_QUALIFIER unsigned long long int lanemask_eq()
    {
        unsigned long long int m = 1ull << laneid();
        return m;
    }

    _CG_STATIC_QUALIFIER unsigned long long int lanemask_lt()
    {
	unsigned long long int m = (1ull << laneid()) - 1ull;
	return m;
    }
#else
    _CG_STATIC_QUALIFIER unsigned int laneid()
