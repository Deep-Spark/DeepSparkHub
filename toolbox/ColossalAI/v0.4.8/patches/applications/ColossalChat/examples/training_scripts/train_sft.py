...
def train(args):
    ...
    # ckpt config for Qwen2-3B 36 layers
    hybrid_kwargs = {
        "gradient_checkpoint_config": PipelineGradientCheckpointConfig(
            num_ckpt_layers_per_stage=[2, 0, 0, 0],
        ),
    } if args.custom_ckpt else {}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--custom_ckpt", default=False, action="store_true")
