...
__all__ = ["FusedLayerNorm", "FusedRMSNorm", "LayerNorm", "RMSNorm", "BaseLayerNorm", "FusedRMSNormResidual"]
...
class FusedRMSNormResidual(nn.Module):
    def __init__(self) -> None:
        raise NotImplementedError(
            "FusedRMSNormResidual is not implemented as a physical class. "
            "It is meant to be used only with the from_native_module interface"
            "to Convert a native RMSNorm(from transformers) module to ixformer FusedRMSNormRes module."
        )
    ...
    def from_native_module(module: nn.Module, *args, **kwargs) -> nn.Module:
        ...
        new_module = FusedRMSNormRes(normalized_shape,
                                     eps=eps,
