...
from ..modeling.qwen2 import (
    ...
    get_qwen2_decoder_layer_forward,
)
...
class Qwen2Policy(Policy):
    ...
    def module_policy(self) -> Dict[Union[str, nn.Module], ModulePolicyDescription]:
        ...
        # replace Qwen2MLP with FusedMLP
        self.append_or_create_submodule_replacement(
            description=SubModuleReplacementDescription(
                suffix="mlp",
                target_module=FusedMLP,
                kwargs=None,
            ),
            policy=policy,
        ...
        if self.shard_config.enable_fused_normalization:
            self.append_or_create_submodule_replacement(
                description=[
                    ...
                    SubModuleReplacementDescription(
                        ...
                        target_module=FusedRMSNormResidual,
                        kwargs={"sp_partial_derived": sp_partial_derived},
                    ),
                ],
                policy=policy,
            ...
            self.append_or_create_method_replacement(
                description={
                    "forward": get_qwen2_decoder_layer_forward(),
                },
                policy=policy,
                target_key=Qwen2DecoderLayer,
            )
