...
from colossalai.shardformer.layer._operation import LinearWithFusedGradAccu
...
class PaddingLMHead(PaddingParallelModule):
    ...
    def forward(self, input: Tensor) -> Tensor:
        ...
        output = LinearWithFusedGradAccu.apply(input, self.weight, self.bias)
...
class LinearWithFusedGradientAccu(torch.nn.Linear):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

    def forward(self, input):
        return LinearWithFusedGradAccu.apply(input, self.weight, self.bias)
