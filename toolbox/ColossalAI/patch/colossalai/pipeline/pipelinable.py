...
class PipelinableContext(InsertPostInitMethodToModuleSubClasses):
    ...
    def partition(self, num_chunks, pipeline_size, rank, model_prefix=None):
        """
        ...
        if isinstance(self._policy, str):
            if self._policy == "uniform":
                ...
                parts = partition_balanced(param_counts, pipeline_size, num_chunks, model_prefix=model_prefix)[rank]
