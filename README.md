...
| [DeepSeek-LLM-7B](nlp/llm/deepseek-llm-7b/verl)       | PyTorch   | verl               | deepseek-llm-7b-chat   | dev-only  |
| [GLM-4](nlp/llm/glm-4/pytorch)                        | PyTorch   | Torchrun           | glm-4-9b-chat          | 4.2.0     |
| [Gemma-2-2B-IT](nlp/llm/gemma-2-2b-it/verl)           | PyTorch   | verl               | gemma-2-2b-it          | dev-only  |
...
| [Qwen2-7B](nlp/llm/qwen2-7b/verl)                     | PyTorch   | verl               | qwen2-7b               | dev-only  |
...
| [Qwen2.5-VL-7B](nlp/llm/qwen2.5-vl-7b/verl)           | PyTorch   | verl               | qwen2.5-vl-7b          | dev-only  |
| [Qwen3-8B](nlp/llm/qwen3-8b/verl)                     | PyTorch   | verl               | qwen3-8b               | dev-only  |
